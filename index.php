...
//INSERT
$query = "INSERT INTO patient VALUES ('$icPatient', '$password', '$patientFirstName', '$patientLastName', '$patientDOB', '$patientGender', '$patientEmail')";
...
<html lang="en">
    ...
    <body>
		...
		<p align="center">For millions of people, HeloDoc is the trusted and familiar home where they know they’ll find a healing touch. It connects them with everything they <br>need to take good care of themselves and their family - assessing health issues, finding the right doctor, booking diagnostic tests, obtaining <br>medicines, storing health records or learning new ways to live healthier. <br><br>Healthcare providers can also harness the power of HeloDoc as the definitive platform that helps them build their presence, grow establishments<br> and engage patients more deeply than ever.</p>
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            <h4>Neurology</h4>
                            <p>Neurology is the specialty within the medical field pertaining to nerves and the nervous system. Neurologists diagnose and treat diseases of the brain, spinal cord, peripheral nerves, muscles, autonomic nervous system, and blood vessels.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            <h4>Ophthalmology</h4>
                            <p>Physicians specializing in ophthalmology develop comprehensive medical and surgical care of the eyes. Ophthalmologists diagnose and treat vision problems.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            <h4>Dermatology</h4>
                            <p>Dermatologists are physicians who treat adult and pediatric patients with disorders of the skin, hair, nails, and adjacent mucous membranes. They diagnose everything from skin cancer, tumors, inflammatory diseases of the skin, and infectious diseases.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            <h4>Urology</h4>
                            <p>Urology is the health care segment that cares for the male and female urinary tract, including kidneys, ureters, bladder, and urethra. It also deals with the male sex organs.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            <h4>Radiaton Oncology</h4>
                            <p>Physicians specializing in radiation oncology treat cancer with the use of high-energy radiation therapy. By targeting radiation doses in small areas of the body, radiation oncologists damage the DNA of cancer cells, preventing further growth.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            <h4>Pediatrics</h4>
                            <p>Physicians specializing in pediatrics work to diagnose and treat patients from infancy through adolescence. Pediatricians practice preventative medicine and also diagnose common childhood diseases, such as asthma, allergies, and croup.</p>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">Copyright © 2020, HeloDoc. All rights reserved.</p>
