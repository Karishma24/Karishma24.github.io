						...
						<div class="col-md-3 col-sm-3">
							...
							<div class="user-wrapper">
								...
								<div class="description">
									...
									<h5><?php echo $userRow['patientGender']; ?></h5>
									<hr />
									<h5><?php echo $userRow['patientEmail']; ?></h5>
									<br>
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><a href="profile.php" style="color:white; text-decoration:none;">View Profile</a></button>
								</div>
							</div>
						</div>
