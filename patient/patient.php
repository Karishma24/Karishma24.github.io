		...
		<nav class="navbar navbar-default " role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="patient.php"><img alt="Brand" src="logo.png" height="40px"></a>
				</div>
		...
		<section id="content-1-9" class="content-1-9 content-block">
			<div class="container">
				<div class="underlined-title">
					<h1>Get in Touch</h1>
					<hr>
					<p>For our patients’ comfort and safety during COVID-19, HeloDoc combines the best of healthcare and technology to make its doctors available to you via online video consultations. Get quick and expert medical advice within minutes. Our doctors will assess and diagnose your symptoms and provide the required treatment plan.</p> 
				</div>
				<!-- /.row -->
			</div>
		</section>
